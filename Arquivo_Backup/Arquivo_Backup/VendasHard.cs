...
namespace Arquivo_Backup
{
    ...
    // 
    //  [DebuggerVisualizer(typeof(VendasHard))]
    //  [Serializable]
    ...
    /// </summary>
    public class VendasHard : DialogDebuggerVisualizer
    {
        ...
        // 
        //    VendasHard.TestShowVisualizer(new SomeType());
        // 
        /// <summary>
        ...
        {
            VisualizerDevelopmentHost visualizerHost = new VisualizerDevelopmentHost(objectToVisualize, typeof(VendasHard));
